...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      // Perform the form submission here. You can add your logic.
  ...
  return (
    <div className="contact">
            ...
            <form id="contact-form" name="contact-form" action="mail.php" method="POST" onSubmit={handleSubmit}>
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="md-form mb-0">
                    <input type="text" id="email" name="email" class="form-control" value={email} onChange={(e) => setEmail(e.target.value)} />
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="md-form">
                    <textarea type="text" id="message" name="message" rows="2" class="form-control md-textarea" value={message} onChange={(e) => setMessage(e.target.value)} />
                  </div>
                </div>
              </div>
      ...
      <div style={{ height: '500px', width: '1270px' }}>
        ...
        <h6 style={{ marginLeft: '50px', marginTop: '-28px', fontWeight: 'normal' }}>Hospital staff is very good and very cooperative</h6>
        <h5 style={{ color: 'grey' }}>Bairstow:</h5>
        <h6 style={{ marginLeft: '90px', marginTop: '-28px', fontWeight: 'normal' }}>Facilities in the hospital are amazing</h6>
        <h5 style={{ color: 'grey' }}>Hazzle:</h5>
        <h6 style={{ marginLeft: '70px', marginTop: '-28px', fontWeight: 'normal' }}>Great to see they are accepting Government Health Cards. This is good for the people who don't have much capacity to afford</h6>
        <h5 style={{ color: 'grey' }}>Wood:</h5>
        <h6 style={{ marginLeft: '65px', marginTop: '-28px', fontWeight: 'normal' }}>Staff is very good; they are keeping an eye on cleanliness in rooms</h6>
      </div>
    </div>
  );
}
